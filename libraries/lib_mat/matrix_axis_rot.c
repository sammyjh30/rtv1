...
/*   Updated: 2019/01/03 08:59:54 by shillebr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_mat	matrix_axis_rot(t_vec3 axis, double angle)
{
	...
	if (!(vec3_len(axis)) || !angle)
		return (rot);
	printf("Axis Rot: [%f %f %f]\n\n", axis.x, axis.y, axis.z);
	vec3_nor(&axis);
	printf("Axis Rot Norm: [%f %f %f]\n\n", axis.x, axis.y, axis.z);
	s = sin(angle);
	c = cos(angle);
	t = 1 - c;
	...
	printf("Rot test\n[%f %f %f]\n[%f %f %f]\n[%f %f %f]\n\n", rot.mat[0][0], rot.mat[0][1], rot.mat[0][2], rot.mat[1][0], rot.mat[1][1], rot.mat[1][2], rot.mat[2][0], rot.mat[2][1], rot.mat[2][2]);
